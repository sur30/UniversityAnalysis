...
#keywords_list = [['2','%23Giants'],['2','%23NewyorkGiants'],['2','%23nygiants'],['4','%23Eagles'],['4','%23PhiladelphiaEagles'],['11','%23Redskins'],['11','%23WashingtonRedskins'],['31','%23dallascowboys'],['31','%23Cowboys']]
keywords_list = [['11','Redskins'],['31','dallascowboys'],['2','Giants'],['4','Eagles']]
#keywords_list = [['4','Eagles']]

#dates_list = ['2013-09-04','2013-09-05','2013-09-06','2013-09-07']
#dates_list = ['2014-01-08','2014-01-09']
dates_list = S.date_list()
tweet_info = csv.writer(open("./tweet_ids_new2.csv",'wb+'))
for k1 in range(len(keywords_list)):
    print keywords_list[k1][1]
    #k2= keywords_list[k1][1].strip("@")
    k2 = keywords_list[k1][1]
    print k2
    for d1 in range(len(dates_list)-1):
        start_date  = dates_list[d1]
        ...
        q ="from%3A"+k2 +" since:" + start_date + " until:" + end_date
        print q
            ...
            try:
                ...
                for l in tid:
                    ...
                    if tid is None:
                        ...
                        info.append(keywords_list[k1][1])
                        info.append(d1)
                        info.append(str(tid))
        ...
        k3 = "hashtag"+keywords_list[k1][1].strip("%23")
        html_twitter =(open("./Dump/" +k3+"-"+dates_list[d1]+'.html','wb+'))
